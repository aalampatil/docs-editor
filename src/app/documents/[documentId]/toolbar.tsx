...
const LineHeightButton = () => {
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent className="border p-1 flex flex-col gap-y-1 ">
  ...
  return (
    <>
      <DropdownMenu>
        ...
        <DropdownMenuContent >
          <DropdownMenuItem onClick={() => uplaod()}  >
            <UploadIcon className="size mr-2" />
            Upload
          </DropdownMenuItem>
          <DropdownMenuItem onClick={() => { setIsDialogOpen(true) }}>
            <SearchIcon className="size mr-2" />
            Paste image url
          </DropdownMenuItem>
        </DropdownMenuContent>
      </DropdownMenu>
